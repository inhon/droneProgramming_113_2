...
if(sys.argv[1] == "base"):
    ...
    baseDrone.takeoff(setting.BASE_HEIGHT) #Waiting for manual confirmation for takeoff. blocking
    ...
    roverDrone.takeoff(setting.ROVER_HEIGHT) #Waiting for manual confirmation for takeoff. blocking
